...
const SettingsPage: React.FC = () => {
  ...
  return (
      <div className="p-8">
        ...
        <div className="bg-slate-100 dark:bg-slate-800 rounded-lg p-6 max-w-2xl border border-slate-200 dark:border-slate-700 space-y-6">
            <div className="flex items-center justify-between">
                ...
                <select 
                    ...
                    className="bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded px-3 py-2 text-sm text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
