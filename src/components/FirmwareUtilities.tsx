            ...
            <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 shadow-lg flex-1 flex flex-col min-h-0">
                <div className="flex gap-6 h-full">
                    ...
                    <div className="w-1/3 flex flex-col gap-4">
                        <div className="bg-slate-900 rounded-lg p-4 border border-slate-700 flex-1 flex flex-col items-center justify-center relative overflow-hidden">
                            {convertPreview ? (
                    ...
                    <div className="flex-1 flex flex-col">
                        <div className="flex justify-between items-center mb-2">
                            <h3 className="text-sm font-bold text-slate-300">Generated C Code</h3>
                            <button 
                        ...
                        <textarea 
                            value={convertCode}
                            readOnly
                            className="flex-1 bg-black/50 border border-slate-700 rounded-lg p-4 font-mono text-xs text-green-400 resize-none focus:outline-none"
